...
import com.adnonstop.perfectrecyclerview.adapter.MultiRefreshAdapter;
...
public class MulitiItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnMultiItemClickListener(new OnMultiItemClickListeners<String>() {
            @Override
            public void onItemClick(BaseViewHolder baseViewHolder, String data, int position, int viewType) {
